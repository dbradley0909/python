...
colors = ['blue','pink','yellow','white','black']
...
# (try to think about how you can do this dynamically, meaning, if the array contents were to change, your code would still work).
